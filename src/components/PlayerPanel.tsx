...
export default function PlayerPanel({ player, ballsRemaining, totalBalls, onReset }: PlayerPanelProps) {
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-xs">
          <span className="text-slate-400">Balls Left</span>
      ...
      <div className="space-y-2">
        <button
          onClick={onReset}
          className="w-full py-2 rounded-lg text-xs font-bold text-white uppercase tracking-wider transition-all duration-200 hover:scale-105 active:scale-95 cursor-pointer"
          style={{
            background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
